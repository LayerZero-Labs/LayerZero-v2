...
module oapp::oapp_core {
    ...
    use oapp::oapp_store::{Self, OAPP_ADDRESS};

    friend oapp::oapp;

    #[test_only]
    friend oapp::oapp_core_tests;
    ...
    public fun get_lz_receive_module_name(): String {
        endpoint::get_lz_receive_module(oapp::oapp_store::OAPP_ADDRESS())
    }

    #[view]
    public fun get_lz_compose_module_name(): String {
        endpoint::get_lz_compose_module(oapp::oapp_store::OAPP_ADDRESS())
    }
