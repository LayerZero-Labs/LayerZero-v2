...
module oapp::oapp_core_tests {
    ...
    use oapp::oapp_core::{Self, withdraw_lz_fees};
    ...
    #[test]
    #[expected_failure(abort_code = oapp::oapp_core::EINSUFFICIENT_NATIVE_TOKEN_BALANCE)]
    ...
    #[test]
    #[expected_failure(abort_code = oapp::oapp_core::EINSUFFICIENT_ZRO_BALANCE)]
