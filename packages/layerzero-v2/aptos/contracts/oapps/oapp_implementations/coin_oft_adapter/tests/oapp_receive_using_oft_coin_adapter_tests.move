#[test_only]
module oft::oapp_receive_using_oft_coin_adapter_tests {
    ...
    fun test_receive() {
        ...
        let escrow = oft_adapter_coin::escrow_address();
        let predeposit = placeholder_coin::mint_for_test(200000);
        aptos_account::deposit_coins<PlaceholderCoin>(escrow, predeposit);
