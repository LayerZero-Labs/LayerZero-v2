...
module oft::oft_adapter_coin_tests {
    ...
    fun test_set_fee_bps() {
        ...
        let coin_value = coin::mint(amount_ld, &mint_cap);
    ...
    fun test_set_blocklist_credit() {
        ...
        let to_escrow = coin::mint(10_000_000, &mint_cap);
        oft_adapter_coin::debit_coin(
            @123456,
            &mut to_escrow,
            0,
    ...
    fun test_set_blocklist_debit() {
        ...
        std::aptos_account::deposit_coins(blocklisted_address, coin::mint(10_000, &mint_cap));
        ...
        let debit_tokens = coin::mint(1234, &mint_cap);
        oft_adapter_coin::debit_coin(
            blocklisted_address,
            &mut debit_tokens,
            0,
        ...
        coin::burn(debit_tokens, &burn_cap);
    ...
    fun test_withdraw_coin() {
        ...
        let coin = oft_adapter_coin::withdraw_coin<AptosCoin>(account, 90);
