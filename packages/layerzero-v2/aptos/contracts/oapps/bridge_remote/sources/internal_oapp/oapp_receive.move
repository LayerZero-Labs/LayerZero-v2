...
module bridge_remote::oapp_receive {
    use std::fungible_asset::FungibleAsset;
    use std::option::{Self, Option};
    use std::string::utf8;
    use std::type_info::{module_name, type_of};

    use bridge_remote::bridge::{lz_receive_impl, next_nonce_impl};
    use bridge_remote::oapp_core::get_peer_bytes32;
    use bridge_remote::oapp_store::{Self, is_native_token};
    ...
    public fun init_module_for_test() {
        init_module(&std::account::create_signer_for_test(bridge_remote::oapp_store::OAPP_ADDRESS()));
    }
