...
module bridge_remote::oapp_core {
    use std::event::emit;
    ...
    use bridge_remote::oapp_store::{Self, OAPP_ADDRESS};
    ...
    #[test_only]
    friend bridge_remote::oapp_core_tests;
    #[test_only]
    ...
    public fun get_lz_receive_module_name(): String {
        endpoint::get_lz_receive_module(bridge_remote::oapp_store::OAPP_ADDRESS())
    }

    #[view]
    public fun get_lz_compose_module_name(): String {
        endpoint::get_lz_compose_module(bridge_remote::oapp_store::OAPP_ADDRESS())
    }
