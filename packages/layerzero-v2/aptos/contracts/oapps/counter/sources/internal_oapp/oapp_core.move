...
module counter::oapp_core {
    ...
    use counter::oapp_store::{Self, OAPP_ADDRESS};
    ...
    public fun get_lz_receive_module_name(): String {
        endpoint::get_lz_receive_module(counter::oapp_store::OAPP_ADDRESS())
    }

    #[view]
    public fun get_lz_compose_module_name(): String {
        endpoint::get_lz_compose_module(counter::oapp_store::OAPP_ADDRESS())
    }
